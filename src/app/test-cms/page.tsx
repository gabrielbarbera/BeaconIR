              ...
              {result.error && (
                <div className="mt-4 p-4 bg-red-900/20 border border-red-500/30 rounded-lg">
                  ...
                  <p className="text-xs text-gray-400 mt-2">
                    This is normal if content types aren't configured yet in
                    Strapi. Create your admin account and add content first.
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="mt-8 p-6 bg-deep-navy rounded-lg border border-gold/20">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            <li>
              ...
              <code className="text-gold">{cmsUrl}/admin</code>
            </li>
