      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-block">
            <img
              src="/images/logos/beaconir-logo-icon.svg"
              alt="Beacon IR"
              width={64}
              height={64}
              className="mx-auto"
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 p-8 space-y-6">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-primary w-full py-3 px-4 rounded-lg bg-gold hover:bg-gold/90 text-deep-navy font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
            >
